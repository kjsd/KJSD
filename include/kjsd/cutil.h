...
#define KJSD_SASSERT(exp, msg) static char KJSD_##msg##__[(exp)?1:-1]
 ...
 * @return 配列の要素数
 */
#define KJSD_LENGTH(x) (sizeof(x)/sizeof(x[0]))
 ...
 */
#define KJSD_OFFSETOF(type, member) ((_UWORD)&((type*)0)->member)
...
#include <windows.h>
#define KJSD_MSLEEP(ms) Sleep(ms)
#else
#include <unistd.h>
#define KJSD_MSLEEP(ms) sleep(KJSD_DIV_ROUND_UP(ms, 1000))
#endif
